          ...
          children: <Widget>[
            Container(
                ...
                child: Column(
                  children: <Widget>[
                    Container(
                      child: Text('Total Pajak Yang Harus Anda Bayar Adalah', textAlign: TextAlign.center, style: TextStyle(color: Colors.black, fontSize: 20.0,fontWeight: FontWeight.w500,),),
                    ...
                    Text(
                      "Pajak Pada Kendaraan Bermotor : ${pajak} ",
